    ...
    >
      ...
      <div :if={@live_action == :index} class="space-y-6">
        <.browser_toolbar
          ...
          manifests={@manifests}
        />
        <.component_grid manifests={@filtered_manifests} filtered_count={length(@filtered_manifests)} />
      </div>
    ...
    >
      ...
      >
        <div class="bg-base-200 h-36 flex items-center justify-center overflow-hidden p-3">
          <div
            class="pointer-events-none w-full origin-top-left"
            style="transform: scale(0.65); width: 154%; max-height: 160%;"
          >
            <Renderer.node
