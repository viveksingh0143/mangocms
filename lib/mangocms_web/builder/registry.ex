defmodule MangoCMSWeb.Builder.Registry do
  ...
  @manifest_modules [
    ...
    Manifests.Paragraph,
    Manifests.RichText,
    Manifests.Blockquote,
    Manifests.CodeBlock,
    Manifests.OrderedList,
    Manifests.UnorderedList,
    Manifests.TextGradient,
    Manifests.LabelText,
    # ── Media ─────────────────────────────────────────────────────────────────────
    Manifests.Image,
    Manifests.Video,
    ...
    Manifests.IconBlock,
    # ── Content / Marketing ───────────────────────────────────────────────────────
    Manifests.FeatureCard,
    Manifests.FeatureGrid,
    Manifests.CtaSection,
    Manifests.Testimonial,
    Manifests.TestimonialGrid,
    Manifests.PricingCard,
    Manifests.PricingTable,
    Manifests.TeamMember,
    Manifests.TeamGrid,
    Manifests.FaqSection,
    Manifests.Banner,
    Manifests.LogoGrid,
    Manifests.StepsSection,
    Manifests.EmptyState,
    Manifests.NotificationBar,
    # ── Interactive / Utility ─────────────────────────────────────────────────────
    Manifests.CopyButton,
    Manifests.ReadMore,
    Manifests.ScrollToTop,
    Manifests.CookieBanner,
    Manifests.BackLink,
    Manifests.ShareButtons,
    Manifests.TableOfContents,
    # ── Action ────────────────────────────────────────────────────────────────────
    Manifests.Button,
    # ── UI Library (DaisyUI) ──────────────────────────────────────────────────────
    Manifests.Accordion,
